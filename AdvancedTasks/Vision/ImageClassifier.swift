...
final class ImagePredictor {
    ...
    private func createImageClassificationRequest() -> VNImageBasedRequest {
        ...
        let model = modelCache.getImageClassifierModel()
        let imageClassificationRequest = VNCoreMLRequest(model: model,
    ...
    /// Manages caching of vision model to impove memory performance
    private let modelCache: ModelCache
    
    init(modelCache: ModelCache) {
